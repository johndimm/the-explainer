...
const translations = {
  en: {
    ...
    singleLineDesc: 'Click once to select a line, then click the same line again to submit it.',
  ...
  fr: {
    ...
    singleLineDesc: 'Cliquez une fois pour sélectionner une ligne, puis cliquez sur la même ligne pour l\'envoyer.',

...
const translations = {
  en: {
    ...
    educationalLevelDesc: 'Set your highest level of education to receive explanations tailored to your knowledge level. A high school dropout will get simple explanations with everyday examples, while a PhD will receive sophisticated academic discourse.',
    searchInterface: 'Search Interface',
    textSearch: 'Text Search',
    textSearchDesc: 'Use the search bar in the text panel to find specific words or phrases. Results are highlighted in the text and you can navigate between matches.',
    searchNavigation: 'Search Navigation',
    searchNavigationDesc: 'Use the up/down arrows to navigate between search results. The current result is highlighted in a different color.',
    searchKeyboard: 'Keyboard Shortcuts',
    searchKeyboardDesc: 'Press Enter to go to next result, Shift+Enter for previous result, and Escape to clear the search.',
    ...
    tip7: 'Educational level: Set your highest education level in Profile Settings to get explanations tailored to your knowledge. A high school dropout gets simple explanations, while a PhD gets sophisticated academic discourse.',
  ...
  fr: {
    ...
    educationalLevelDesc: 'Définissez votre niveau d\'éducation le plus élevé pour recevoir des explications adaptées à votre niveau de connaissances. Un décrocheur du lycée recevra des explications simples avec des exemples quotidiens, tandis qu\'un doctorant recevra un discours académique sophistiqué.',
    searchInterface: 'Interface de Recherche',
    textSearch: 'Recherche de Texte',
    textSearchDesc: 'Utilisez la barre de recherche dans le panneau de texte pour trouver des mots ou phrases spécifiques. Les résultats sont mis en surbrillance dans le texte et vous pouvez naviguer entre les correspondances.',
    searchNavigation: 'Navigation de Recherche',
    searchNavigationDesc: 'Utilisez les flèches haut/bas pour naviguer entre les résultats de recherche. Le résultat actuel est mis en surbrillance dans une couleur différente.',
    searchKeyboard: 'Raccourcis Clavier',
    searchKeyboardDesc: 'Appuyez sur Entrée pour aller au résultat suivant, Maj+Entrée pour le résultat précédent, et Échap pour effacer la recherche.',
    ...
    tip7: 'Niveau d\'éducation : Définissez votre niveau d\'éducation le plus élevé dans les Paramètres du Profil pour obtenir des explications adaptées à vos connaissances. Un décrocheur du lycée reçoit des explications simples, tandis qu\'un doctorant reçoit un discours académique sophistiqué.',
